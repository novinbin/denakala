        ...
        <div class="row d-flex justify-content-start my-4 bg-white">
            <div class="col-lg-4 col-md-4 col  my-5  border-bottom title-add-to-stock">
                <div class="alert my-4">
                    <h3> {{ __('messages.categories') . ' - ' . $category->title }}</h3>
                </div>
            </div>
        </div>
            ...
            <form wire:submit="store">
                ...
                <div class="row  py-2 bg-white rounded">
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <a href="{{ route('admin.category.create') }}" class="btn btn-primary">دسته بندی ها پایه</a>
       ...
       {{-- <div class="row d-flex justify-content-center search-category-section">
            ...
            <div class="my-5">
                <table class="table table-striped table-responsive">
                    ...
                    @if(is_null($subCategories))
                        <div class="my-4">{{ __('messages.there_is_no_category_for_display') }}</div>
                    @else
                        @foreach($subCategories as $category)
                            <tr class="text-center">
                                ...
                                <td>
                                    <a wire:click.prevent="edit({{ $category->id }})" href="javascript:void(0)" class="mx-4">
        ...
        <div class="row d-flex justify-content-center bg-white my-4 ">
            <div class="col-lg-2 col-md-2 my-2 pt-2 pb-2 ">
                @if(!is_null($subCategories))
                    {{ $subCategories->links(data: ['scrollTo' => false]) }}
                @endif
