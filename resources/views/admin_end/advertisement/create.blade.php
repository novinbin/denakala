...
@section('dash_main_content')
    <div class="container-fluid">
        <div class="mx-auto my-5 bg-white row product-create-body">
            <form action="{{ route('admin.adv.store') }}" method="post"  enctype="multipart/form-data" id="advertisement-form">
            @csrf
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            {{-- {{ $province->id == old("province")  ? "selected": "" }} --}}
                            ...
                            <div class="mt-5  col">
                                <label for="description" class="mb-2 form-label">
                                    <span style="margin-left: 10px"><i class="fa fa-star text-danger" style="font-size:10px"></i></span>شرح آگهی
                                </label>
                                <textarea class="mt-1 form-control" rows="8" id="description" name="description">{{ old('description') }}</textarea>
                                @error('description')
                                <div class="mt-3 alert alert-danger">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="mt-5  col">
                                <label for="advertiser_phone" class="form-label"><span style="margin-left: 10px">
                                        <i class="fa fa-star text-danger" style="font-size:10px"></i></span>تلفن / موبایل
                                </label>
                            ...
                            <div class="mt-5 mb-5  col" >
                                <label for="keywords" class="form-label">
                                    <span style="margin-left: 10px"><i class="fa fa-star text-danger" style="font-size:10px"></i></span>عبارات کلیدی
                                </label>
                                <input type="hidden"  name="keywords" id="keywords" value="{{ old('keywords') }}">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-5 col" style="margin-top:2rem">
                                ...
                                @if($categories->isEmpty())
                                    <div style="margin-top:1rem" class="bg-white  border alert d-flex justify-content-center border-1 border-secondary no-categories">
                                        <p class="my-auto text-center">{{ __('messages.there_is_no_ad_grouping') }}</p>
                                    </div>
                                @else
                                    <div class="category-content mt-5 py-2" style="max-height:750px;overflow-y:auto">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.province-select').select2({
              ...
              // set old province & old city if validation error
              // city select
            $('.city-select').select2({
