...
class SingleProduct extends Component
{
    ...
    public function mount(Advertisement $product)
    {
        ...
        $this->relatedProducts =
            Advertisement::where('status', 1)->where('marketable_number', '>', 0)->select(['id', 'title_persian', 'origin_price', 'thumbnail_image', 'slug'])->get();
        $this->colors =
